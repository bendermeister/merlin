...
BENCH_combine_find_2(const mrln_str8view_t haystack[static 1],
...
static BENCH_combine_result_t
BENCH_combine_find_3(const mrln_str8view_t haystack[static 1],
                     const mrln_str8view_t needle[static 1]) {
...
static BENCH_combine_result_t
BENCH_combine_find_1(const mrln_str8view_t haystack[static 1],
                     const mrln_str8view_t needle[static 1]) {
...
static BENCH_combine_result_t
BENCH_combine_find_4(const mrln_str8view_t haystack[static 1],
                     const mrln_str8view_t needle[static 1]) {
...
static BENCH_combine_result_t
BENCH_combine_find_long_needle(const mrln_str8view_t haystack[static 1],
                               const mrln_str8view_t needle[static 1]) {
...
static BENCH_combine_result_t
BENCH_combine_find(const mrln_str8view_t haystack[static 1],
                   const mrln_str8view_t needle[static 1]) {
...
static int BENCH_combine_replace_inplace_char(mrln_str8_t s[static 1],
...
static int
BENCH_combine_replace_inplace(mrln_str8_t s[static 1],
...
static int BENCH_combine_replace(mrln_str8_t s[static 1],
                                 const mrln_str8view_t target[static 1],
                                 const mrln_str8view_t replacement[static 1]) {
...
static bench_timer_t BENCH_combine_bench(mrln_str8view_t target[static 1],
