...
BENCH_findallpcome_find(const mrln_str8view_t haystack[static 1],
...
static int
BENCH_findallpcome_replace(mrln_str8_t s[static 1],
...
BENCH_findallpcome_bench(mrln_str8view_t target[static 1],
