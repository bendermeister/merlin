...
BENCH_pfindallpcome_find(const merlin_str8_view_t haystack[static 1],
...
static int
BENCH_pfindallpcome_replace(merlin_str8_t s[static 1],
...
BENCH_pfindallpcome_bench(merlin_str8_view_t target[static 1],
